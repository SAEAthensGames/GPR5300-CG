...
int main()
{
	...
	// --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Lighting Maps 2", NULL, NULL);
	if (window == NULL)
	{
	...
	// ------------------------------------
	Shader lightingShader("lightingMaps1.vs", "lightingMaps2.fs");
	...
	std::string str2 = "container_specular.png";
